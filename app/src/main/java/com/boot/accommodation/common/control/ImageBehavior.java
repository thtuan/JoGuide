...
public class ImageBehavior extends CoordinatorLayout.Behavior<CircularImageView> {
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.avatar_height_la);
    }
    ...
    private void maybeInitProperties(CircularImageView child, View dependency) {
        ...
        if (finalHeight == 0)
            finalHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.avatar_height_me);
