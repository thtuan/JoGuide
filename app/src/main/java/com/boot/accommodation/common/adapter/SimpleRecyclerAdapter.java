...
//        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        viewHolder = new VersionViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder versionViewHolder, int i) {
        if (isHomeList) {
            ((VersionViewHolder) versionViewHolder).title.setText(homeActivitiesList.get(i));
            ((VersionViewHolder) versionViewHolder).subTitle.setText(homeActivitiesSubList.get(i));
        } else {
            ((VersionViewHolder) versionViewHolder).title.setText(versionModels.get(i));
        }
    }
