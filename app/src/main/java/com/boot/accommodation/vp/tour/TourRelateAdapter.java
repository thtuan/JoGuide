 ...
 * @since: 6/10/2016
 */
public class TourRelateAdapter extends BaseRecyclerViewAdapter<TripItemDTO, TourRelateAdapter.ViewHolder> {

    public TourRelateAdapter(List<TripItemDTO> items) {
        super(items);
    }
    ...
    static class ViewHolder extends BaseRecyclerViewHolder {
        ...
        public void bind(TripItemDTO item, int position) {
            ...
            if (item.getPhoto() != null && item.getPhoto().size() > 0) {
                ...
                ivFavouriteResult.setImageResource(R.drawable.img_default_error);
            }
        ...
        public void OnClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.llFavouriteResult:
                    action = Constants.ActionEvent.ACTION_VIEW_TOUR_INFO;
                    break;
            }
