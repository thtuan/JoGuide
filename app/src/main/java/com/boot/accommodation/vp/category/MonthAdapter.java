 ...
 */
public class MonthAdapter extends ArrayAdapter<CategoryItemDTO> {

    private Context context; //Context
    private List<CategoryItemDTO> items = new ArrayList<>();
    private List<CategoryItemDTO> itemsAll;
    private List<CategoryItemDTO> suggestions;

    public MonthAdapter(Context context, int resource, List<CategoryItemDTO> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CategoryItemDTO areaDTO = items.get(position);
        if (convertView == null) {
